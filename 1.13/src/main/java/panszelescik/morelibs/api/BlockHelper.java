...
public class BlockHelper {
	...
	static {
		rotateType[getId(Blocks.ACACIA_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.BIRCH_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.SANDSTONE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.SPRUCE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.STONE_BRICK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.STONE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.BRICK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.COBBLESTONE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.DARK_OAK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.DARK_PRISMARINE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.JUNGLE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.NETHER_BRICK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.OAK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.PETRIFIED_OAK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.PRISMARINE_BRICK_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.PRISMARINE_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.PURPUR_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.QUARTZ_SLAB)] = RotationType.SLAB;
		rotateType[getId(Blocks.RED_SANDSTONE_SLAB)] = RotationType.SLAB;
		
		rotateType[getId(Blocks.TRAPPED_CHEST)] = RotationType.CHEST;
		rotateType[getId(Blocks.CHEST)] = RotationType.CHEST;
		rotateType[getId(Blocks.ENDER_CHEST)] = RotationType.CHEST;

		rotateType[getId(Blocks.ACACIA_STAIRS)] = RotationType.STAIRS;
		...
		rotateType[getId(Blocks.COBBLESTONE_STAIRS)] = RotationType.STAIRS;
		rotateType[getId(Blocks.DARK_OAK_STAIRS)] = RotationType.STAIRS;
		rotateType[getId(Blocks.DARK_PRISMARINE_STAIRS)] = RotationType.STAIRS;
		...
		rotateType[getId(Blocks.PRISMARINE_BRICK_STAIRS)] = RotationType.STAIRS;
		rotateType[getId(Blocks.PRISMARINE_STAIRS)] = RotationType.STAIRS;
