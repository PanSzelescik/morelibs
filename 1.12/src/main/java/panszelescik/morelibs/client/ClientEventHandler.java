...
import static panszelescik.morelibs.MoreLibs.MODID;
...
public final class ClientEventHandler {
	...
	public static void onRenderOverlayPre(RenderGameOverlayEvent.Pre event)
	{
		if(ZoomHelper.isZooming&&event.getType()==RenderGameOverlayEvent.ElementType.CROSSHAIRS)
		{
			...
			{
				ClientHelper.bindTexture("immersiveengineering:textures/gui/scope.png");
				...
				ClientHelper.bindTexture("immersiveengineering:textures/gui/hud_elements.png");
